...
//                            appState.addProduct.add(Errand(
//                              price: price,
//                              text: items
//                            ));
                            ...
                            child: Center(
                              child: Container(
                                ...
                                height: 40,
                                color: kPrimaryColor,
                                child: Center(child: Text('Proceed',style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold), )),
                              ),
                            ),
                            )
                                ],
